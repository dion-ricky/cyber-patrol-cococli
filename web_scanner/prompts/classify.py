def build_classify_prompt(url: str) -> str:
    return f"""
OBJECTIVE:
...
Indicators:
- Domain name is similar but not the official brand domain
  (e.g., samsung.xyz for samsung.com)
...
F) BLOCKED_BY_GOVERNMENT — Redirected with message
  "SITUS INI DIBLOKIR OLEH PEMERINTAH INDONESIA"
G) CLOUDFLARE_BLOCKED — Shows "Verifying you are human",
  "Checking your browser", "Cloudflare", or "Just a moment..."
